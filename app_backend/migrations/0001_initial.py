    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bank_provider_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_backend.BankProvider')),
                ('user_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_backend.User')),
            ],
        ),
        migrations.CreateModel(
            name='Transaction',
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('account_id', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app_backend.Account')),
            ],
        ),
        migrations.AddField(
